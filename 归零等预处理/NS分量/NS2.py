...
input_file = "C:/Users/tian/Desktop/data/fenliang/NS_adjusted_1.txt"
output_file = "C:/Users/tian/Desktop/data/fenliang/NS_adjusted_2.txt"
...
time_periods = [
    ...
    # 添加其他时间段及其对应的常数值，
    {
        ...
        'end_date': pd.to_datetime('2011-01-28', format='%Y-%m-%d'),
        'constant': -12349
    },
