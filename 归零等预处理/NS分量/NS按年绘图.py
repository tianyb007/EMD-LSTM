...
# 读取数据
data_file = "C:/Users/tian/Desktop/zuankong/fenliang/NS_adjusted_3_mod.txt"
...
# 指定保存图像的路径
output_path = "C:/Users/tian/Desktop/zuankong/pic/NS/"
...
for year in range(start_year, end_year + 1):
    ...
    plt.title(f"NS Borehole Strain Data for {year}")
