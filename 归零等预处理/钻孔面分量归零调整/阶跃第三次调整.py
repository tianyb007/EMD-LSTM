...
input_file = "C:/Users/tian/Desktop/data/zuankong_adjusted_2.txt"
output_file = "C:/Users/tian/Desktop/data/zuankong_adjusted_3.txt"
...
time_periods = [
    {
        ...
        'end_date': pd.to_datetime('2008-12-30', format='%Y-%m-%d'),
        'constant': 70944
    },
    {
        'start_date': pd.to_datetime('2010-01-01', format='%Y-%m-%d'),
        'end_date': pd.to_datetime('2010-01-29', format='%Y-%m-%d'),
        'constant': 28738
    },
    # 添加其他时间段及其对应的常数值，
    {
        'start_date': pd.to_datetime('2011-01-31', format='%Y-%m-%d'),
        'end_date': pd.to_datetime('2011-02-28', format='%Y-%m-%d'),
        'constant': -41208
    },
    {
        'start_date': pd.to_datetime('2011-03-01', format='%Y-%m-%d'),
        'end_date': pd.to_datetime('2011-05-09', format='%Y-%m-%d'),
        'constant': 40713
    },
    {
