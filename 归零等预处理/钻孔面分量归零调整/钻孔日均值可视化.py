...
data_file = "C:/Users/tian/Desktop/data/zuankong_adjusted_5.txt"
# data_file = "C:/Users/tian/Desktop/zuankong/fenliang/z1.txt"
# 从txt文件中读取数据并转换为列表
...
for line in lines:
    ...
    for idx, value in enumerate(values):
        if float(value) == 999999 or float(value) == 999999.0:
            values[idx] = np.nan
        else:
...
# fig.tight_layout()
plt.title("Daily Average Strain")
plt.show()
