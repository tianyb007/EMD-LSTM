...
input_file = "C:/Users/tian/Desktop/data/ZUANKONG.txt"
output_file = "C:/Users/tian/Desktop/data/zuankong_adjusted.txt"
...
time_periods = [
    ...
    # 添加其他时间段及其对应的常数值，
    {
        'start_date': pd.to_datetime('2009-01-01', format='%Y-%m-%d'),
        'end_date': pd.to_datetime('2009-06-17', format='%Y-%m-%d'),
        'constant': -29490
    },
    {
    ...
    },
    {
        ...
        'end_date': pd.to_datetime('2010-04-13', format='%Y-%m-%d'),
        'constant': -87127
    },
    {
    ...
    {
        'start_date': pd.to_datetime('2011-03-01', format='%Y-%m-%d'),
        'end_date': pd.to_datetime('2011-12-31', format='%Y-%m-%d'),
        'constant': -67929
    },
    {
        'start_date': pd.to_datetime('2011-01-01', format='%Y-%m-%d'),
        'end_date': pd.to_datetime('2012-12-31', format='%Y-%m-%d'),
        'constant': -50000
    },
    {
        'start_date': pd.to_datetime('2013-01-01', format='%Y-%m-%d'),
        'end_date': pd.to_datetime('2013-08-07', format='%Y-%m-%d'),
        'constant': -70000
    },
    {
        'start_date': pd.to_datetime('2013-08-08', format='%Y-%m-%d'),
        'end_date': pd.to_datetime('2014-04-02', format='%Y-%m-%d'),
        'constant': -127929
    },
    {
