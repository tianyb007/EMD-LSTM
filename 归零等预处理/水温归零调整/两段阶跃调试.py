...
input_file = "C:/Users/tian/Desktop/data/day_change_adjusted_all.txt"
output_file = "C:/Users/tian/Desktop/data/day_change_adjusted_all2.txt"
...
time_periods = [
    ...
    {
        'start_date': pd.to_datetime('2021-09-01', format='%Y-%m-%d'),
