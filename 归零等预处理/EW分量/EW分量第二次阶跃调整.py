...
input_file = "C:/Users/tian/Desktop/data/fenliang/EW_adjusted_2.txt"
output_file = "C:/Users/tian/Desktop/data/fenliang/EW_adjusted_3.txt"
...
time_periods = [
    {
        ...
        'end_date': pd.to_datetime('2010-04-16', format='%Y-%m-%d'),
        'constant': 6415
    },

    # 添加其他时间段及其对应的常数值，
    {
        'start_date': pd.to_datetime('2011-02-01', format='%Y-%m-%d'),
        'end_date': pd.to_datetime('2011-04-14', format='%Y-%m-%d'),
        'constant': -9872
    },
    {
    ...
    {
        'start_date': pd.to_datetime('2021-11-21', format='%Y-%m-%d'),
