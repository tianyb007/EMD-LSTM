...
input_file = "C:/Users/tian/Desktop/data/fenliang/EW_adjusted_3.txt"
output_file = "C:/Users/tian/Desktop/data/fenliang/EW_adjusted_4.txt"
...
time_periods = [
    {
        ...
        'end_date': pd.to_datetime('2008-10-15', format='%Y-%m-%d'),
        'constant': 3908
    },

    # 添加其他时间段及其对应的常数值，
    {
        'start_date': pd.to_datetime('2008-10-21', format='%Y-%m-%d'),
    ...
    {
        'start_date': pd.to_datetime('2022-07-01', format='%Y-%m-%d'),
        'end_date': pd.to_datetime('2022-07-21', format='%Y-%m-%d'),
        'constant': 12243
    }
]
