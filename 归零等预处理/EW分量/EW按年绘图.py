...
# 读取数据
data_file = "C:/Users/tian/Desktop/zuankong/fenliang/EW_adjusted_4.txt"
...
# 指定保存图像的路径
output_path = "C:/Users/tian/Desktop/zuankong/pic/EW/"
...
for year in range(start_year, end_year + 1):
    ...
    plt.title(f"EW Borehole Strain Data for {year}")
