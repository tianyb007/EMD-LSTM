...
# 读取数据
data_file = "C:/Users/tian/Desktop/zuankong/fenliang/NE_adjusted_3.txt"
...
# 指定保存图像的路径
output_path = "C:/Users/tian/Desktop/zuankong/pic/NE/"
...
for year in range(start_year, end_year + 1):
    ...
    plt.title(f"NE Borehole Strain Data for {year}")
