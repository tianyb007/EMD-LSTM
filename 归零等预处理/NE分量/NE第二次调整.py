...
input_file = "C:/Users/tian/Desktop/data/fenliang/NE_adjusted_1.txt"
output_file = "C:/Users/tian/Desktop/data/fenliang/NE_adjusted_2.txt"
...
time_periods = [
    {
        ...
        'end_date': pd.to_datetime('2011-01-29', format='%Y-%m-%d'),
        'constant': -19459
    },
    {
    ...
    },
    {
        ...
        'end_date': pd.to_datetime('2021-03-31', format='%Y-%m-%d'),
        'constant': -288402
    }
]
